...
# Build Date:   Fri May  3 13:30:50 BST 2019
# ------------------------------------------------------------------------
...
def GenerateConfig(context):
  ...
  deployment_script_location = str(context.properties.get('deployment_script_location', 'https://storage.googleapis.com/sapdeployment'))
